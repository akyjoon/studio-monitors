...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _movies = __webpack_require__(328);
	      ...
	      fetch(this.url).then(function (resp) {
	        resp.json().then(function (data) {
	          ...
	          movies.forEach(function (movie) {
	            console.log(movie);
	            _this.apiHolder.innerHTML += '<li>' + movie.title + '</li>';
	          });
	        });
	      })
	      //errors
	...
	var Nav = function () {
	  ...
	  _createClass(Nav, [{
	    ...
	    value: function open() {
	      ...
	      this.navButton.addEventListener('click', function (e) {
	        _this.navWrap.classList.toggle("navigation_wrapper--show");
	        _this.upperLine.classList.toggle("navigation_mobile-button_upper-line--x");
	        _this.middleLine.classList.toggle("navigation_mobile-button_middle-line--x");
	        _this.bottomLine.classList.toggle("navigation_mobile-button_bottom-line--x");
	      });
	    }
	  }, {
	    key: 'close',
